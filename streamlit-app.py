...
Original file is located at
    https://colab.research.google.com/drive/1w8hub--r2ileXWUAOGzQ5Q0T1Ib_D6pN
"""
...
if prediction == 1:
  ...
  * **Expected ROI:** ค่าใช้จ่ายในการโทร+ส่วนลด คุ้มค่ากว่าการหาลูกค้าใหม่
  ...
  st.error(f"✅ มีความเสี่ยงน้อยโดยที่ลูกค้ารายนี้มีแนวโน้มใช้งานต่อ (โดยมีความเสี่ยงเพียง {propability: .1%})")
